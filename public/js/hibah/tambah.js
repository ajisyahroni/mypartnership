$(document).ready(function () {
    ...
    // $('input[name="penanggung_jawab_kegiatan"]').change(function () {
    //     $(".wrapper-dekan").fadeOut(function () {
    //         $(this).addClass("d-none");
    //     });
    //     $(".wrapper-kaprodi").fadeOut(function () {
    //         $(this).addClass("d-none");
    //     });
    //     if ($(this).val() === "kaprodi") {
    //         $(".wrapper-kaprodi").removeClass("d-none").hide().fadeIn();
    //     } else if ($(this).val() === "dekan") {
    //         $(".wrapper-dekan").fadeOut(function () {
    //             $(this).addClass("d-none");
    //         });
    //     } else if ($(this).val() === "")
    //         $("#penanggung_jawab_kegiatan").val(""); // Reset input jika tidak dicentang
    // });
