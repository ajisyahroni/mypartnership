$(document).ready(function () {
    ...
    let urlHapus = "/referensi/lembaga_ums/destroy";

    function openModal(data = null) {
        formInput.get(0).reset(); // Reset form input

        $("input[name='id_lmbg']").val(data?.id_lmbg || "");
        $("input[name='nama_lmbg']").val(data?.nama_lmbg || "");
        $("input[name='namalmbg_singkat']").val(data?.namalmbg_singkat || "");
        $("input[name='status_tempat']").val(data?.status_tempat || "");
        $("select[name='jenis_lmbg']")
            .val(data?.jenis_lmbg || "")
            .trigger("change");
        $("select[name='super_unit']")
            .val(data?.super_unit || "")
            .trigger("change");
    ...
    $("#dataTable").on("click", ".btn-edit", function () {
        let data = {
            id_lmbg: $(this).data("id_lmbg"),
            nama_lmbg: $(this).data("nama_lmbg"),
            namalmbg_singkat: $(this).data("namalmbg_singkat"),
            status_tempat: $(this).data("status_tempat"),
            jenis_lmbg: $(this).data("jenis_lmbg"),
            super_unit: $(this).data("super_unit"),
        };
