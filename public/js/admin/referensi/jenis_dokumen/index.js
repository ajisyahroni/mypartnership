$(document).ready(function () {
    ...
    let urlHapus = "/referensi/jenis_dokumen/destroy";
    ...
    function openModal(data = null) {
        ...
        $("input[name='ttd'][value='" + (data?.ttd || "") + "']").prop(
            "checked",
            true
        );

        // Pastikan data.lingkup_unit tidak undefined/null sebelum split
        let selectedUnits = data?.lingkup_unit
            ? data.lingkup_unit.split(",").map((unit) => unit.trim())
            : [];

        // Reset semua checkbox terlebih dahulu
        $("input[name='lingkup_unit[]']").prop("checked", false);

        // Centang checkbox yang sesuai jika ada data
        $("input[name='lingkup_unit[]']").each(function () {
            if (selectedUnits.includes($(this).val().trim())) {
    ...
    $("#dataTable").on("click", ".btn-edit", function () {
        let data = {
            ...
            ttd: $(this).data("ttd"),
            lingkup_unit: $(this).data("lingkup_unit"),
        };
