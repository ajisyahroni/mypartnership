$(document).ready(function () {
    ...
    let urlHapus = "/referensi/jenis_institusi_mitra/destroy";
    ...
    function openModal(data = null) {
        ...
        $("input[name='bobot_dikti']").val(data?.bobot_dikti || "");
        $("input[name='bobot_ums']").val(data?.bobot_ums || "");
        $("select[name='alias']")
            .val(data?.alias || "")
            .trigger("change");
    ...
    $("#dataTable").on("click", ".btn-edit", function () {
        let data = {
            id: $(this).data("id"),
            klasifikasi: $(this).data("klasifikasi"),
            keterangan: $(this).data("keterangan"),
            alias: $(this).data("alias"),
            bobot_dikti: $(this).data("bobot_dikti"),
            bobot_ums: $(this).data("bobot_ums"),
        };
