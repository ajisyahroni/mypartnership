$(document).ready(function () {
    ...
    $("#formInput").on("submit", function (e) {
        ...
        $.ajax({
            ...
            contentType: false, // Tidak mengubah tipe konten
            success: function (response) {
                ...
                // Kamu bisa menambahkan lebih banyak logika di sini
            },
            error: function () {
                let errorMessages = "";
...
function fillSurvey(id_table, jenis) {
    ...
    $.ajax({
        url: "/survei/" + id_table + "/" + jenis, // Ganti dengan route yang sesuai untuk mengambil form
        method: "GET",
        success: function (response) {
...
function showSurveyNotifikasi() {
    $.ajax({
        url: "/survei/getSurveiImplementasi",
        method: "GET",
        success: function (response) {
            // Isi konten modal dengan response (form pengisian survei)
