...
use App\Mail\NewMessageRekognisiNotification;
...
class SendEmailChatRekognisi implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        foreach ($arrReceiver as $email) {
            try {
                Mail::to($email)->send(new NewMessageRekognisiNotification($this->message, $this->sender));
