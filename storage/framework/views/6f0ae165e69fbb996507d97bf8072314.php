...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/pilihmenu.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/pilih_menu/responsive.css')); ?>">
</head>
<body>
    <!-- Background Shapes -->
    ...
    <div class="top-bar">
        <div class="user-info">
            ...
            <span><?php echo e(ucwords(session('current_role'))); ?></span>
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="header-section">
            <div class="logo-container">
                <img src="<?php echo e(asset('images/logo_ums_blue.png')); ?>" alt="Logo UMS">
            </div>
            <h1>MyPartnership</h1>
        ...
        <div class="menu-grid">
            ...
            <a href="#" class="menu-card menu-switch" data-menu="mypartnership" data-title="Kerja Sama">
                <div class="menu-icon-wrapper">
                    ...
                    <?php if(($notif_kerjasama ?? 0) > 0): ?>
                        <span class="notification-badge high"><?php echo e($notif_kerjasama); ?></span>
                    <?php endif; ?>
                </div>
                <h3>Kerja Sama</h3>
            ...
            <a href="#" class="menu-card menu-switch" data-menu="recognition" data-title="Rekognisi Dosen">
                <div class="menu-icon-wrapper">
                    ...
                    <?php if(($notif_rekognisi ?? 0) > 0): ?>
                        <span class="notification-badge high"><?php echo e($notif_rekognisi); ?></span>
                    <?php endif; ?>
                </div>
            ...
            <a href="#" class="menu-card menu-switch" data-menu="partner" data-title="Mitra Potensial">
                <div class="menu-icon-wrapper">
                    ...
                    <?php if(($notif_partner ?? 0) > 0): ?>
                        <span class="notification-badge high"><?php echo e($notif_partner); ?></span>
                    <?php endif; ?>
                </div>
            ...
            <a href="#" class="menu-card menu-switch" data-menu="hibah" data-title="Hibah Kerja Sama">
                 <div class="menu-icon-wrapper">
                    ...
                    <?php if(($notif_hibah ?? 0) > 0): ?>
                        <span class="notification-badge high"><?php echo e($notif_hibah); ?></span>
                    <?php endif; ?>
                </div>
...
</html><?php /**PATH /var/www/resources/views/pilih_menu.blade.php ENDPATH**/ ?>