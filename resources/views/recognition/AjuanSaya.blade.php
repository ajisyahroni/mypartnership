...
@section('contents')
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="javascript:void(0)" target="_blank"
                                                    class="dropdown-item d-flex align-items-center btn-download-rekognisi-user">
                                                    <i class="bx bx-spreadsheet me-2"></i> Download Ajuan Saya Rekognisi
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
    ...
    <div class="modal fade" id="surveyFillModal" tabindex="-1" aria-labelledby="surveyFillModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
...
@push('scripts')
    <script>
        ...
        var urlGetSurvei = @json(route('getSurveiRecognition'));
        var getDetailRecognition = "{{ route('recognition.getDetailRecognition') }}"
        var showRevisiUrl = "{{ route('recognition.showRevisi') }}"
    
    </script>
    <script src="{{ asset('js/recognition/detailAjuan.js') }}"></script>
    <script src="{{ asset('js/recognition/survei.js') }}"></script>
    <script>
