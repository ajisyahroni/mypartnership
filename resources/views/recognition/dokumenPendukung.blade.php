...
@section('contents')
                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                @if (session('current_role') == 'admin')
                                    <button id="btnTambah" class="btn btn-primary btn-sm shadow-sm" data-bs-toggle="modal"
            ...
            <div class="modal fade" id="modal-form" aria-labelledby="DetailLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('recognition.storeDokumenPendukung') }}" enctype="multipart/form-data"
                                ...
                                <div class="row p-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="link_dokumen"
                                                name="link_dokumen" placeholder="Masukkan Link Dokumen" value="">
                                        </div>
    ...
    <script src="{{ asset('js/recognition/dokumenPendukung.js') }}"></script>
@endsection

@push('scripts')
    <script>
        var UrlsetDokumen = @json(route('recognition.setDokumen'));
