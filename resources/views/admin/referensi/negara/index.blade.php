                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="DetailLabel">Form Referensi Negara</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <form action="{{ route('referensi.negara.store') }}" method="post" id="formInput">
                            @csrf
                            <div class="modal-body">
                                <div class="row p-3">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label for="capital" class="form-label">Ibu Kota <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="capital" name="capital"
                                                placeholder="Masukkan Ibu Kota" value="">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@push('scripts')
    <script>
        var getData = "{{ route('referensi.negara.getData') }}"
    </script>
    <script src="{{ asset('js/admin/referensi/negara/index.js') }}"></script>
@endpush
