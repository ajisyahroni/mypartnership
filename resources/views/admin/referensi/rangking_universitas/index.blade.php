                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="DetailLabel">Form Referensi Rangking Universitas</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <form action="{{ route('referensi.rangking_universitas.store') }}" method="post" id="formInput">
                            @csrf
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="type" name="type"
                                                placeholder="Masukkan Tipe" value="">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@push('scripts')
    <script>
        var getData = "{{ route('referensi.rangking_universitas.getData') }}"
    </script>
    <script src="{{ asset('js/admin/referensi/rangking_universitas/index.js') }}"></script>
@endpush
