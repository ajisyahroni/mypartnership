                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="DetailLabel">Form Referensi Jabatan UMS</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <form action="{{ route('referensi.jabatan.store') }}" method="post" id="formInput">
                            @csrf
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="nama_jabatan" name="nama_jabatan"
                                                placeholder="Masukkan Nama Jabatan" value="">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@push('scripts')
    <script>
        var getData = "{{ route('referensi.jabatan.getData') }}"
    </script>
    <script src="{{ asset('js/admin/referensi/jabatan/index.js') }}"></script>
@endpush
