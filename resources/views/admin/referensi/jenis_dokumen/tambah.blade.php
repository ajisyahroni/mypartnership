                        ...
                        <div class="content">
                            <div class="container mt-4">
                                <form action="{{ route('pengajuan.store_baru') }}" enctype="multipart/form-data"
                                    ...
                                    <input type="hidden" name="place_stat" id="place_stat"
                                        ...
                                        {{-- <div class="accordion-item">
                                            <h2 class="accordion-header">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#collapseKeterangan" aria-expanded="true"
                                                    style="background: linear-gradient(135deg, #e00b44, #ab0027);">
                                                    <i class="fa-solid fa-triangle-exclamation me-2"></i> Keterangan
                                                </button>
                                            </h2>
                                            <div id="collapseKeterangan" class="accordion-collapse collapse show">
                                                <div class="accordion-body" style="border-left:4px solid #c60536">
                                                    <div class="card mb-3 alert alert-danger">
                                                        <div class="card-body">
                                                            @if (@$stats_kerma == 'Lapor Kerma')
                                                                <h5 class="fw-bold text-center w-100">"Halaman ini berisi
                                                            ...
                                                            <div class="row mb-3 align-items-center">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <div id="tingkat_kerjasama_wrapper">
                                                                        <div id="tingkat_kerjasama" class="d-none">
                                                                            @foreach ($tingkat_kerjasama as $tingkat)
                                                                                <div
                                                                                    class="form-check {{ $tingkat->check }}">
