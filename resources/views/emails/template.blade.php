...
<head>
    <title>MyPartnership - Universitas Muhammadiyah Surakarta</title>
</head>
    ...
    <table align="center" width="100%" cellspacing="0" cellpadding="0"
        ...
        <tr>
            <td style="padding: 30px;">
                <h3 style="color: #333333; margin-bottom: 20px;">Pesan Baru</h3>

                <div style="font-size: 12px; line-height: 1.7; color: #333;">
                    {!! $dataMessage !!}
                </div>

                <div style="font-size: 14px; margin-top: 30px; border-top: 1px solid #ddd; padding-top: 20px;">
                    <p style="margin: 5px 0;"><strong>Dikirim oleh:</strong> {{ $sender }}</p>
                    <p style="margin: 5px 0;"><strong>Judul:</strong> {{ $subject }}</p>
                </div>
            </td>
        </tr>
