    ...
    <body>
            ...
            <div class="container-fluid h-100 position-relative">
                <div class="row h-100">
                    ...
                    <div class="col-md-6 left-section d-flex flex-column align-items-center position-relative curva-bg"
                        ...
                        <div class="d-flex align-items-center w-100 px-4 scroll-animate">
                            <div class="d-flex align-items-center justify-content-center" style="height: 50px;">
                                <img src="{{ asset('images/ums_white.png') }}" alt="Logo UMS" style="height: 100%;">
                                {{-- <img src="{{ asset('images/logo_ums.png') }}" alt="Logo UMS" style="height: 100%;"> --}}
                            </div>
                        ...
                        <div class="w-75 scroll-animate">
                            {{-- <img src="{{ asset('images/mahasiswa_ums.jpg') }}" --}}
                            <img src="{{ asset('images/Edutorium-UMS-2-1.jpg') }}"
                    ...
                    <div class="col-md-6 right-section d-flex flex-column" style="padding-top:6rem;">
                        ...
                        <form class="mt-4 scroll-animate" action="{{ route('login') }}" method="post" id="formLogin">
                            @csrf
                ...
                <div class="row justify-content-center text-center g-4">
                    ...
                    <div class="col-md-3 col-sm-6 scroll-animate duration-300" style="cursor: pointer">
                        <div class="card shadow-sm p-4 h-100 summary-card"
                            ...
                            <h1 class="fw-bold mt-2 display-number">{{ $dataMoU }}</h1>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6 scroll-animate duration-200" style="cursor: pointer">
                        <div class="card shadow-sm p-4 h-100 summary-card"
                            ...
                            <h1 class="fw-bold mt-2 display-number">{{ $dataMoA }}</h1>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6 scroll-animate duration-300" style="cursor: pointer">
                        <div class="card shadow-sm p-4 h-100 summary-card"
                            ...
                            <h1 class="fw-bold mt-2 display-number">{{ $dataIA }}</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container d-flex flex-wrap justify-content-between">
                ...
                <div class="mt-3">
                    ...
                    <div class="d-flex gap-3">
                        <a href="https://mail.google.com/mail/?view=cm&fs=1&to={{ @$dataSetting->email }}"
        ...
        <script>
            ...
            `);
                ...
                $.ajax({
                    url: "{{ route('login.dokumenPendukung') }}",
                    method: "GET",
