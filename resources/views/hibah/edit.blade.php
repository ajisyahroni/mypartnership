                    ...
                    <div class="card shadow-lg border-0 rounded-4">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    @if (@$dataHibah->id_hibah)
                                            <button class="btn btn-warning btn-export" data-title-tooltip="Print Ajuan Hibah"
                                                data-id_hibah="{{ @$dataHibah->id_hibah ?? '' }}">
                                                <i class="bx bx-printer"></i> Cetak Proposal
                                            </button>
                                        @endif
                        ...
                        <div class="card-body p-4">
                            ...
                            <form action="" method="post" id="formInput" enctype="multipart/form-data">
                                ...
                                @if (
                                    $dataHibah->status_revisi_kaprodi == '0' ||
                                        $dataHibah->status_revisi_dekan == '0' ||
                                        $dataHibah->status_revisi_admin == '0' ||
                                        $dataHibah->status_revisi_laporan == '0')
                                    @php
                                        $catatan = '';
                                        if ($dataHibah->status_revisi_kaprodi == '0') {
                                            $catatan = $dataHibah->catatan_kaprodi;
                                        } elseif ($dataHibah->status_revisi_dekan == '0') {
                                            $catatan = $dataHibah->catatan_dekan;
                                        } elseif ($dataHibah->status_revisi_admin == '0') {
                                            $catatan = $dataHibah->catatan_admin;
                                        } elseif ($dataHibah->status_revisi_laporan == '0') {
                                            $catatan = $dataHibah->catatan_laporan;
                                        }
                                    @endphp
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" name="judul_proposal"
                                                                    ...
                                                                    value="{{ @$dataHibah->judul_proposal ?? '' }}">
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                            <label
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" name="institusi_mitra"
                                                                    ...
                                                                    value="{{ @$dataHibah->institusi_mitra ?? '' }}">
                                                            </div>
                                                        </div>
                                                                ...
                                                                <select id="jenis_hibah" name="jenis_hibah"
                                                                    ...
                                                                    @foreach ($jenis_hibah as $jns_hibah)
                                                                        <option value="{{ $jns_hibah->id }}"
                                                                            {{ @$dataHibah->id_jenis_hibah == $jns_hibah->id ? 'selected' : '' }}
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" name="ketua_pelaksana"
                                                                    ...
                                                                    value="{{ @$dataHibah->ketua_pelaksana ?? '' }}">
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                            <label class="col-sm-3 col-form-label fw-bold text-dark">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" name="nidn_ketua_pelaksana"
                                                                    ...
                                                                    value="{{ @$dataHibah->nidn_ketua_pelaksana ?? '' }}">
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <select name="penanggung_jawab_kegiatan"
                                                                    ...
                                                                    <option value="kaprodi"
                                                                        {{ @$dataHibah->penanggung_jawab_kegiatan == 'kaprodi' ? 'selected' : '' }}>
                                                                        Kaprodi</option>
                                                                    <option value="dekan"
                                                                        {{ @$dataHibah->penanggung_jawab_kegiatan == 'dekan' ? 'selected' : '' }}>
                                                                        Dekan</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" name="nama_penanggung_jawab"
                                                                    value="{{ @$dataHibah->nama_penanggung_jawab ?? '' }}"
                                                                    id="nama_penanggung_jawab" class="form-control"
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" name="nidn_penanggung_jawab"
                                                                    value="{{ @$dataHibah->nidn_penanggung_jawab ?? '' }}"
                                                        ...
                                                        <div class="row mb-3 align-items-center" id="tgl_selesai_wrapper">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="date" id="tanggal_selesai"
                                                                    name="tgl_selesai" placeholder="Pilih Tanggal Selesai"
                                                                    value="{{ @$dataHibah->tgl_selesai ?? '' }}">
                                                            </div>
                                                        </div>
                                                                ...
                                                                <select id="fakultas" name="fakultas"
                                                                    ...
                                                                    @foreach ($fakultas as $fak)
                                                                        <option value="{{ $fak->id_lmbg }}"
                                                                            ...
                                                                            {{ @$dataHibah->fakultas == $fak->id_lmbg ? 'selected' : '' }}>
                                                                            {{ $fak->nama_lmbg }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                                ...
                                                                <select id="prodi" name="prodi"
                                                                    ...
                                                                    @foreach ($program_studi as $prodi)
                                                                        <option value="{{ $prodi->id_lmbg }}"
                                                                            ...
                                                                            {{ @$dataHibah->prodi == $prodi->id_lmbg ? 'selected' : '' }}>
                                                                            {{ $prodi->nama_lmbg }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <textarea name="latar_belakang" id="latar_belakang" class="form-control" cols="30" rows="5"
                                                                    placeholder="Masukkan Latar Belakang maksimum {{ @$settingHibah->latar_belakang_proposal }} karakter...">{{ @$dataHibah->latar_belakang ?? '' }}
                                                                </textarea>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <textarea name="tujuan" id="tujuan" class="form-control" cols="30" rows="5"
                                                                    placeholder="Masukkan Tujuan maksimum {{ @$settingHibah->tujuan_proposal }} karakter...">
                                                                    {{ @$dataHibah->tujuan ?? '' }}
                                                                </textarea>
                                                                <small class="text-muted d-block mt-2">
                                                                    * Wajib diisi, 
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-9">
                                                                ...
                                                                <textarea name="detail_institusi_mitra" id="detail_institusi_mitra" class="form-control" cols="30"
                                                                    rows="5"
                                                                    placeholder="Masukkan Detail Instruksi Mitra maksimum {{ @$settingHibah->detail_institusi_mitra }} karakter...">
                                                                    {{ @$dataHibah->detail_institusi_mitra ?? '' }}
                                                                </textarea>
                                                                <small class="text-muted d-block mt-2">
                                                                    * Wajib diisi, 
                                                                ...
                                                                <select id="jenis_kerma" name="jenis_kerma"
                                                                    ...
                                                                    @foreach ($jenis_kerma as $jenis)
                                                                        <option value="{{ $jenis->nama_dokumen }}"
                                                                            ...
                                                                            {{ @$dataHibah->jenis_kerma == $jenis->nama_dokumen ? 'selected' : '' }}>
                                                                            {{ $jenis->nama_dokumen }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-9">
                                                                ...
                                                                <textarea name="detail_kerma" id="detail_kerma" class="form-control" cols="30" rows="5"
                                                                    placeholder="Masukkan Detail Kerja Sama maksimum {{ @$settingHibah->detail_kerma }} karakter...">
                                                                    {{ @$dataHibah->detail_kerma ?? '' }}
                                                                </textarea>
                                                                <small class="text-muted d-block mt-2">
                                                                    * Wajib diisi, maksimal
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <textarea name="target" id="target" class="form-control" cols="30" rows="5"
                                                                    placeholder="Masukkan Target Output dan Outcome maksimum {{ @$settingHibah->target_proposal }} karakter...">
                                                                    {{ @$dataHibah->target ?? '' }}
                                                                </textarea>
                                                                 <small class="text-muted d-block mt-2">
                                                                    * Wajib diisi, 
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <textarea name="indikator_keberhasilan" id="indikator_keberhasilan" class="form-control" cols="30"
                                                                    rows="5"
                                                                    placeholder="Masukkan Indikator Keberhasilan maksimum {{ @$settingHibah->indikator_keberhasilan }} karakter...">
                                                                {{ @$dataHibah->indikator_keberhasilan ?? '' }}
                                                                </textarea>
                                                                <small class="text-muted d-block mt-2">
                                                                    * Wajib diisi, 
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <textarea name="rencana" id="rencana" class="form-control" cols="30" rows="5"
                                                                    placeholder="Masukkan Rencana Keberlanjutan maksimum {{ @$settingHibah->rencana_proposal }} karakter...">
                                                                {{ @$dataHibah->rencana ?? '' }}
                                                            </textarea>
                                                                <small class="text-muted d-block mt-2">
                                                                    * Wajib diisi, 
                                                        ...
                                                        <div class="row mb-3">
                                                            <div class="col-sm-3">
                                                                <label class="col-form-label fw-bold text-dark">Upload
                                                                    File Tambahan <span></label><br>
                                                                @if (count(@$logFileLain) > 0)
                                                                    <button type="button"
                                                                        class="btn btn-outline-primary btn-sm btn-detail-log"
                                                                        data-log="{{ json_encode(@$logFileLain) }}">Log
                                                                        Draft</button>
                                                                @endif
                                                            </div>
                                                            <div class="col-sm-9">
                                                                <input type="file" name="file_lain"
                                                                    class="form-control custom-file-input" accept=".pdf"
                                                                    placeholder="Upload File">
                                                                @if (@$dataHibah->file_lain != null)
                                                                    <small style="font-size: 12px;"><a target="_blank"
                                                                            href="{{ asset('storage/' . @$dataHibah->file_lain) }}">Lihat
                                                        ...
                                                        <table id="tabelPengeluaran"
                                                            ...
                                                            <tbody>
                                                                @php
                                                                    ...
                                                                    $jumlah = json_decode(
                                                                        $dataHibah->jumlah_pengeluaran,
                                                                    );
                                                                    $biaya_satuan = json_decode(
                                                                        $dataHibah->biaya_satuan,
                                                                    );
                                                                    $satuan = json_decode($dataHibah->satuan);
                                                                    $biaya_total = json_decode($dataHibah->biaya_total);
                                                                    $sumber = json_decode($dataHibah->sumber_pendanaan);
                                                                    @$sumber_lain = json_decode(
                                                                        $dataHibah->sumber_pendanaan_lain,
                                                                    );
                                                                @endphp
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="sumber-wrapper">
                                                                                <select
                                                                                    class="form-select sumber-pendanaan"
                                                                                    style="background-color: #ffffff;"
                                                                                    name="sumber_pendanaan[]">
                                                                                    <option value="BKUI">BKUI
                                                                                    </option>
                                                                            ...
                                                                            <td>
                                                                                <div class="sumber-wrapper">
                                                                                    <select
                                                                                        ...
                                                                                        name="sumber_pendanaan[]">
                                                                                        <option value="BKUI"
                                                                                            {{ $sumber[$index] == 'BKUI' ? 'selected' : '' }}>
                                                                                            BKUI
                                                                                        </option>
                                                                                        <option value="Lain"
                                                                                            {{ $sumber[$index] == 'Lain' ? 'selected' : '' }}>
                                                                                            Sumber
                                                                                            Lain
                                                                                        </option>
                                                                                    </select>
                                                                                    @if ($sumber[$index] == 'BKUI')
                                                                                        <input type="text"
                                                                                            class="form-control mt-2 sumber-lain"
                                                                                            placeholder="Tulis sumber lain"
                                                                                            name="sumber_pendanaan_lain[]"
                                                                                            style="background-color: #ffffff;display:{{ $sumber[$index] == 'BKUI' ? 'none' : '' }}"
                                                                                            value="{{ @$sumber_lain[$index] }}">
                                                                                    @else
                                                                                        <input type="text"
                                                                                            class="form-control mt-2 sumber-lain"
                                                                                            placeholder="Tulis sumber lain"
                                ...
                                <div class="bg-primary p-3 d-flex justify-content-end">
                                    @if ($dataHibah->add_by == auth()->user()->username)
...
@push('scripts')
    <script src="{{ asset('js/hibah/edit.js') }}"></script>
    <script>
        const arrIdHibah = @json($arrIdHibah);
        const idJenisHibah = @json(@$dataHibah->jenis_hibah ?? 'null');
        const $prodiUser = @json($prodi_user);
        const $fakultasUser = @json($fak_user);
        const $idMou = @json($dataHibah->id_mou);

        if ($idMou) {
            $("#id_mou").val($idMou).trigger("change");
        }
        

        if (idJenisHibah != 'null') {
            if (!arrIdHibah.includes(idJenisHibah)) {
                Swal.fire({
                    icon: "info",
                    title: "Pilih Jenis Hibah",
                    html: "Jenis hibah tidak aktif atau sudah melewati deadline proposal.",
                });
            }
        }
        ...
        function tambahBaris(Jenistable) {
            ...
            `;
                ...
                newRow.innerHTML = `
                    <td>${rowCount + 1}</td>
                    <td><input type="text" class="form-control" name="jenis_pengeluaran[]" style="background-color: #ffffff;" placeholder="Contoh: ATK, Transportasi, dll"></td>
                    <td><input type="number" class="form-control jumlah" name="jumlah_pengeluaran[]" style="background-color: #ffffff;" placeholder="Jumlah"></td>
                    <td><input type="text" class="form-control" name="satuan[]" style="background-color: #ffffff;" placeholder="Contoh: pcs, hari, km, dll"></td>
                    <td><input type="number" class="form-control biaya_satuan" style="background-color: #ffffff;" name="biaya_satuan[]" placeholder="Biaya per satuan"></td>
                    <td><input type="number" class="form-control biaya_total" style="background-color: #ffffff;" name="biaya_total[]" readonly placeholder="Total otomatis"></td>
                    <td>
                        <div class="sumber-wrapper">
                            <select class="form-select sumber-pendanaan" style="background-color: #ffffff;" name="sumber_pendanaan[]">
        ...
        $(document).ready(function() {
            ...
            const tanggalMulai = flatpickr("#tanggal_mulai", {
                ...
                locale: "id",
                allowInput: true,
                defaultDate: $('#tanggal_mulai').val(), // Jika ada, langsung set
            ...
            const tanggalSelesai = flatpickr("#tanggal_selesai", {
                ...
                locale: "id",
                allowInput: true,
                defaultDate: $('#tanggal_selesai').val() // Jika ada, langsung set
            });

            // Simpan opsi semua prodi
            let allProdiOptions = $('#prodi option').clone();

            $(document).ready(function() {
                const initialFakultasId = $('#fakultas').val();
                const initialProdiId = $('#prodi').val();
                ...
                if (initialFakultasId) {
                    ...
                    $('#prodi')
                        .empty()
                        .append('<option value="">Pilih Fakultas Terlebih Dahulu</option>')
                        .trigger('change.select2');
                }

                // Set minDate untuk tgl_selesai jika tgl_mulai sudah ada
                if (tglMulai) {
                    tanggalSelesai.set('minDate', tglMulai);
                }
            });
            ...
            // Jika fakultas berubah manual oleh user
