...
@section('contents')
            ...
            <div class="modal fade" id="modal-form" aria-labelledby="DetailLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('hibah.storeDokumenPendukung') }}" enctype="multipart/form-data"
    ...
    <script src="{{ asset('js/hibah/dokumenPendukung.js') }}"></script>
@endsection

@push('scripts')
    <script>
        var UrlsetDokumen = @json(route('hibah.setDokumen'));
