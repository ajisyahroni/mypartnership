                        ...
                        <div class="content">
                            <div class="container mt-4">
                                <form action="{{ route('pengajuan.store_baru') }}" enctype="multipart/form-data"
                                    ...
                                    @php
                                        $hasRevisi = [
                                            'kaprodi' => $dataPengajuan->status_verify_kaprodi == '0' && $dataPengajuan->status_verify_kaprodi != null,
                                            'admin' => $dataPengajuan->status_verify_admin == '0' && $dataPengajuan->status_verify_admin != null,
                                            'user' => $dataPengajuan->status_verify_user == '0' && $dataPengajuan->status_verify_user != null,
                                            'publish' => $dataPengajuan->status_verify_publish == '0' && $dataPengajuan->status_verify_publish != null,
                                        ];
                                    @endphp
                                    @if ($hasRevisi['kaprodi'] || $hasRevisi['admin'] || $hasRevisi['user'] || $hasRevisi['publish'])
                                        @php
                                            @$catatan = $dataPengajuan->note;
                                            $ket = '';
                                            if ($hasRevisi['kaprodi']) {
                                                $ket = 'dari Kaprodi';
                                            }else if($hasRevisi['admin']){
                                                $ket = 'dari Admin';
                                            }else if($hasRevisi['user']){
                                                $ket = 'dari User';
                                            }else if($hasRevisi['publish']){
                                                $ket = 'Revisi Dokumen Kerja Sama dari Admin';
                                            }
                                        @endphp
                                                                ...
                                                                <div class="col-12 d-flex justify-content-center mt-3">
                                                                    @if (!$fileDraft)
                                                                        <a href="#draftDokumen" class="btn btn-primary"> <i
                                                                            ...
                                                                            </i> Upload Draft Dokumen Kerja Sama</a>
                                                                    @endif
                                                                    @if (@$stats_kerma == 'Lapor Kerma')
                                                                        <a href="#draftDokumenMoU" class="btn btn-primary"> <i
                                                                                class="fa-solid fa-upload me-2">
                                                                            </i> Upload Dokumen Resmi Kerja Sama</a>
                                                                    @elseif (
                                                                        @$stats_kerma == 'Ajuan Baru' &&
                                                                                    $dataPengajuan->tgl_verifikasi_user != '0000-00-00 00:00:00' && (
                                                                                    $dataPengajuan->tgl_req_ttd == '0000-00-00 00:00:00' || $dataPengajuan->file_mou == null
                                                                                )
                                                                            )
                                                                        <a href="#draftDokumenMoU" class="btn btn-primary"> <i
                                                                                class="fa-solid fa-upload me-2">
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" name="nama_internal_pic"
                                                                            class="form-control"
                                                                            value="{{ old('nama_internal_pic', $dataPengajuan->nama_internal_pic ?? '') }}"
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" name="lvl_internal_pic"
                                                                            class="form-control"
                                                                            value="{{ old('lvl_internal_pic', $dataPengajuan->lvl_internal_pic ?? '') }}"
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" name="email_internal_pic"
                                                                            class="form-control"
                                                                            value="{{ old('email_internal_pic', $dataPengajuan->email_internal_pic ?? '') }}"
                                                                            placeholder="Tulis Email PIC Internal disini">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Telepon <span
                                                                                class="text-danger">*</span></label>
                                                                        <input type="number" name="telp_internal_pic"
                                                                            class="form-control"
                                                                            value="{{ old('telp_internal_pic', $dataPengajuan->telp_internal_pic ?? '') }}"
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" name="nama_eksternal_pic"
                                                                            class="form-control"
                                                                            value="{{ old('nama_eksternal_pic', $dataPengajuan->nama_eksternal_pic ?? '') }}"
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" name="lvl_eksternal_pic"
                                                                            class="form-control"
                                                                            value="{{ old('lvl_eksternal_pic', $dataPengajuan->lvl_eksternal_pic ?? '') }}"
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" name="email_eksternal_pic"
                                                                            class="form-control"
                                                                            value="{{ old('email_eksternal_pic', $dataPengajuan->email_eksternal_pic ?? '') }}"
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="number" name="telp_eksternal_pic"
                                                                            class="form-control"
                                                                            value="{{ old('telp_eksternal_pic', $dataPengajuan->telp_eksternal_pic ?? '') }}"
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-3">
                                                                    <label class="col-form-label fw-bold text-dark">Upload
                                                                        SK Pendirian</label><br>
                                                                    @if (count(@$logFileSKMitra) > 0)
                                                                        <button type="button"
                                                                            class="btn btn-outline-primary btn-sm btn-detail-log"
                                                                            data-log="{{ json_encode(@$logFileSKMitra) }}">Log
                                                                            Draft</button>
                                                                    @endif
                                                                </div>
                                                                <div class="col-sm-9">
                                                                    ...
                                                                    @if (@$dataPengajuan->file_sk_mitra != null)
                                                                        <small style="font-size: 12px;"><a target="_blank"
                                                                                href="{{ getDocumentUrl(@$dataPengajuan->file_sk_mitra,'file_mitra') }}">Lihat
                                                        ...
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <div class="row mb-3">
                                                                    <div class="col-sm-3">
                                                                        <label
                                                                            class="col-form-label fw-bold text-dark">Upload
                                                                            Draft
                                                                            Dokumen Kerja Sama <span
                                                                                style="font-size: 12px;color:red;">(Draft)</span></label><br>
                                                                        @if (count(@$logFileAjuan) > 0)
                                                                            <button type="button"
                                                                                class="btn btn-outline-primary btn-sm btn-detail-log"
                                                                                data-log="{{ json_encode(@$logFileAjuan) }}">Log
                                                                                Draft</button>
                                                                        @endif
                                                                    </div>
                                                                    {{-- <label
                                        ...
                                        @if (
                                            @$stats_kerma == 'Lapor Kerma' ||
                                                (@$stats_kerma == 'Ajuan Baru' &&
                                                    ...
                                                    @$dataPengajuan->tgl_verifikasi_user != '0000-00-00 00:00:00'))
                                            <div class="accordion-item" id="draftDokumenMoU">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button" type="button"
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <label
                                                                            ...
                                                                            Dokumen Kerja Sama <span
                                                                                ...
                                                                                Bertanda
                                                                                Tangan)</span></label><br>
                                                                        @if (count(@$logFileMoU) > 0)
                                                                            <button type="button"
                                                                                class="btn btn-outline-primary btn-sm btn-detail-log"
                                                                                data-log="{{ json_encode(@$logFileMoU) }}">Log
                                                                                Draft</button>
                                                                        @endif
                                                                    </div>
                                                                    <div class="col-sm-9">
                                                                        ...
                                                                        @endif
                                                                        <small class="text-muted"
                                                                            style="font-size: 12px;">Optional (tidak
                                                                            wajib
                                                                            diisi).</small><br>
                                                                        <small class="text-danger"
                                                                            style="font-size: 12px;">*Ukuran Maksimal
                                    ...
                                    <div class="bg-primary p-3 d-flex justify-content-end">
                                        @php
                                            $isRevisi = $hasRevisi['kaprodi'] || $hasRevisi['admin'] || $hasRevisi['user'] || $hasRevisi['publish'];

                                            $btnClass = $isRevisi ? 'btn btn-warning' : 'btn btn-light';
                                            $btnText  = $isRevisi ? 'Simpan Perbaikan' : 'Simpan';
                                        @endphp

                                        <button type="submit" class="btn-simpan {{ $btnClass }}">
                                            <i class="fa fa-save me-2"></i> {{ $btnText }}
                                        </button>
                                    </div>
                                </form>
                            </div>
...
@push('scripts')
    ...
    <script>
        ...
        let hasVerifyAdmin = @json(@$dataPengajuan->status_verify_admin == '1');
        let hasVerifyUser = @json(@$dataPengajuan->status_verify_user == '1');

        $(document).ready(function() {
            originalMoUOptions = $("#pilih_mou").html();

            // $('#pilih_mou_wrapper #pilih_mou').select2({
            //     theme: "bootstrap-5",
            ...
            let jenisInstitusiMitra = @json($dataPengajuan->jenis_institusi);
            let dn_ln = @json($dataPengajuan->dn_ln);

            let status_kerma = @json($dataPengajuan->status_kerma);
            let id_mou_perpanjang = @json($dataPengajuan->id_mou_perpanjang);

            let wilayahMitra = '{{ @$dataPengajuan->wilayah_mitra }}';
            ...
            function addInternalCard(nama = "", jabatan = "", index = 0) {
                let hapusButton = index === 0 ? '' :
            ...
            function addEksternalCard(nama = "", jabatan = "", index = 0) {
                let hapusButton = index === 0 ? '' :
            ...
            if (ttdInternal.length > 0 && ttdInternal[0] !== "") {
                ttdInternal.forEach((nama, index) => {
                    addInternalCard(nama, lvlInternal[index] || "", index);
                });
            }
            ...
            if (ttdEksternal.length > 0 && ttdEksternal[0] !== "") {
                ttdEksternal.forEach((nama, index) => {
                    addEksternalCard(nama, lvlEksternal[index] || "", index);
                });
            }
            ...
            if (hasVerifyAdmin) {
                $("#formInput")
                    ...
                    .not('input[name="_token"], input[name="file_ajuan"], input[name="file_mou"], .btn-simpan, .btn-detail-log, #id_mou, #ajuan_kerma_key, #stats_kerma, #place_state')
                    .prop("disabled", true);
                disableFormPenandatangan();
            }
            if (hasVerifyUser) {
                $("#formInput")
                    .find('input[name="file_ajuan"]')
                    .prop("disabled", true);
            }

            function disableFormPenandatangan() {

                $("#collapse4 .dropdown-toggle").addClass("disabled").css("pointer-events", "none");
                $("#collapse4 .dropdown-menu a").css("pointer-events", "none");

                $("#collapse4 .hapus_internal, #collapse4 .hapus_eksternal")
                    .prop("disabled", true)
            ...
            if (dn_ln) {
                $('input[name="dn_ln"]').val(dn_ln).trigger("change");
                setTimeout(function() {
                    if (wilayahMitra) {
                        $('input[name="wilayah_mitra"][value="' + wilayahMitra + '"]').prop("checked", true)
                            .trigger("change");
                    }
                }, 300);
            }
            ...
            // if (wilayahMitra) {
            //     $('input[name="wilayah_mitra"]').val(wilayahMitra).trigger("change");
            // }
            ...
            if (id_mou_perpanjang) {
                $('input[name="status_kerma"][value="Dalam Perpanjangan"]').prop("checked", true).trigger('change')
                setTimeout(function() {
                    if (id_mou_perpanjang) {
                        $("#mou_perpanjangan").val(id_mou_perpanjang).trigger("change");
                    }
                }, 300);
            }else{
                $('input[name="status_kerma"][value="Ajuan Baru"]').prop("checked", true).trigger('change')
            }
            ...
            if (jenisInstitusiMitra) {
                $("#select_institusi_mitra").val(jenisInstitusiMitra).trigger("change");
            }
