...
<body>
    ...
    <div class="main-wrapper mt-5 mb-5">
        ...
        <div class="content-section">
            ...
            <div class="alert alert-primary p-3" role="alert" style="background-color: #b8d5fc;">
                <div class="text-dark text-center">
                    <h5 class="mb-2">Thank You for Your Feedback!</h5>
                    <p>
                        We sincerely appreciate your time and valuable input. <br>
                        Your response has been successfully recorded and will help us to improve our future
                        collaboration.
                    </p>
                    <p>
                        (Terima kasih atas waktu dan masukan yang telah Bapak/Ibu berikan. <br>
                        Jawaban Anda berhasil dikirim dan akan sangat bermanfaat untuk meningkatkan kerja sama ke
                        depan.)
                    </p>
                </div>
            </div>
